...
- SonOff POW R1
  ...
  [Configuration file: templatefiles\sonoff_powr1.yaml](templatefiles/sonoffpowr1.yaml)

- SonOff POW R2
  
  This is a SonOff POW R2
  
  [Configuration file: templatefiles\sonoff_powr2.yaml](templatefiles/sonoffpowr2.yaml)
<!--
- Blackboard-T5
